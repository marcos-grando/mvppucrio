...
import Sobreall from './components/sobre/Sobreall';
        ...
        <>
            ...
            <div className="app">
                <Routes>
                    ...
                    />
                    <Route path="/Calendário" element={<Calendar dataJson={eventday} onlypage='true' />} />
                    <Route path="/Notícias" element={<Newsnow dataJson={updatedNews} onClickNews={clickNews} onlypage='true' />} />
                    <Route path="/Sobre" element={<Sobreall dataJson={sobre} onlypage='true' />} />
                    <Route path="/Notícias/Notícia" element={<Singlenews selectNews={selectNews} />} />
