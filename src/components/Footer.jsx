                ...
                <div className="footer-content">
                    <div className="footer-infos">
                        ...
                        <div className="infos infos-main">
                            ...
                            <p onClick={() => clickNav('/Calendário')} style={{cursor: "pointer"}} >Programação</p>
                            <p onClick={() => clickNav('/Notícias')} style={{cursor: "pointer"}} >Nossas Notícias</p>
                        </div>
                    </div>
                    <div className="infos-local">
                        <div className="local">
                            <p>Endereço:</p>
                            <p>Av. Meira Júnior, 1240 - Jardim Paulistano, Ribeirão Preto - SP, 14090-270</p>
                        </div>
                        <iframe
                    ...
                    <div className="infos-contatos">
                        <p>Telefone: (xx) xxxxx-xxxx</p>
                        <p>Whatsapp: (xx) xxxxx-xxxx</p>
                        <p>Email: cantabile@gmail.com</p>
                    </div>
                </div>
            </div>
        </footer>
